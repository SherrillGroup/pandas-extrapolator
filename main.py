...
def stats1():
    """
    Incorrect sum assumption
    """
    # Compare with CCSD(T)/CBS references: puts in context if scaling factor is
    # improving
    # TODO: only sum for specific level of SAPT. Look at Lori file and determine levels
    sapt0_extrap_columns = [
